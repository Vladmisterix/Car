...
public class TEST:MonoBehaviour
{
    ...
    public void CalculateAndApplySteering(float input, float maxSteerAngle, List<TEST> allAxles)
    {
        //first find farest axle, we got to apply default values
        TEST farestAxle = allAxles[0];
...
public class SimpleCarController : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        foreach (TEST axleInfo in axleInfos)
        {
